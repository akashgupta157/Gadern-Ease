...
const highlight={
    color :"#404040" , fontSize:"15px", 
    fontWeight: "bold" ,
}

return <div>
    <div className="images1" >
<img src="newa.jpg" alt=""  style={{width:"100% " ,height:"400px"}}/>  
<h3 style={{paddingLeft:"20px" ,color :"#404040" , fontSize:"15px", 
    fontWeight: "bold" ,paddingTop:"10px"}}>GREEN LIFE</h3>
<h6 style={{paddingLeft:"20px"}}>Making lavender oil: Preserve the scent of the south</h6>
...
<button className ="buttonprop" style={{margin:"20px 20px"}} >Learn more</button>
</div>
